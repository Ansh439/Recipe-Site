                ...
                userPosts.map((post) => (
                  <Table.Body className='divide-y' key={currentUser._id}>
                    <Table.Row className='bg-white dark:border-gray-700 dark:bg-gray-800'>
                      ...
                      }} className='text-red-500 font-medium hover:underline cursor-pointer'>Delete</span></Table.Cell>
      ...
      <Modal show={showModal} onClose={()=>setShowModal(false)} popup size='md'>
        ...
        <Modal.Body>
          <div className='text-center'>
            ...
            <h3 className='mb-5 text-gray-500 text-lg dark:text-gray-400'>Are you sure you want to delete this post?</h3>
